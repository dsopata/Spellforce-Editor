...
namespace SpellforceGameDataEditor2k16
{
    public static class Utils
    {
        ...
        public static void InitializeListDict()
        {
            ...
            Vars.ListDict.Add("UnitCosts", new List<UnitCosts>());
            Vars.ListDict.Add("UnitCorpseLoot", new List<UnitCorpseLoot>());
            Vars.ListDict.Add("UnitBuildings", new List<UnitBuildings>());
            Vars.ListDict.Add("BuildingStats", new List<BuildingStats>());
            Vars.ListDict.Add("BuildingStats2", new List<BuildingStats2>());
        ...
        public static void WriteAll()
        {
            ...
            UnitCosts.Write(stream);
            UnitCorpseLoot.Write(stream);
            UnitBuildings.Write(stream);
            BuildingStats.Write(stream);
            BuildingStats2.Write(stream);
